        ...
        <div class="container is-fluid">
            <section class="info-tiles">
                <div class="tile is-ancestor has-text-centered">
                    ...
                    {{-- @include('partials.admin.dashboard.tile', ['icon' => 'user',  'value' => $totalArticles, 'key' => 'article'])
                    @include('partials.admin.dashboard.tile', ['icon' => 'users', 'value' => $totalCategory, 'key' => 'category'])
                    @include('partials.admin.dashboard.tile', ['icon' => 'corner-down-left', 'value' => $totalPage , 'key' => 'page'])
                    @include('partials.admin.dashboard.tile', ['icon' => 'globe', 'value' => $totalAllUser, 'key' => 'user']) --}}
                </div>
            </section>
